...
Expand exporter pipeline to emit full findings and submission bundle artifacts.

## Scope

- Extended longitudinal exporter with third-finding outputs.
- Extended submission exporter with findings index/report/submission report outputs.
- Regenerated deterministic evaluation bundle files.
...
- `README.md`
- `TOUR.webm`
- `code/export_longitudinal_findings.py`
- `code/export_zerve_submission_package.py`
- `evidence/findings_report.json`
- `evidence/zerve_submission_package.json`
- `manifest.json`
