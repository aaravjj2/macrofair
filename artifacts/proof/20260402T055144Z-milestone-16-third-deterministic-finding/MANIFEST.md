...
Add and validate a third deterministic finding based on category dislocation-share drift.

## Scope

- Implemented third-finding computation in longitudinal evaluation logic.
- Added third-finding exports (JSON/CSV/SVG + snapshot category shares CSV).
- Extended backend and frontend tests for deterministic third-finding behavior.
...
- `README.md`
- `TOUR.webm`
- `code/longitudinal_findings.py`
- `evidence/third_finding.csv`
- `evidence/third_finding.json`
- `evidence/third_finding.svg`
- `evidence/third_finding_snapshot_category_shares.csv`
- `manifest.json`
