...
Verify publicly reachable frontend and API URLs and capture deterministic response evidence.

## Scope

- Created public URL verification summaries and raw check artifacts.
- Captured public API responses (`health`, `metadata`, `markets`).
- Captured public frontend pages (`/`, `/methodology`) with `data-testid` checks.
...
- `README.md`
- `TOUR.webm`
- `checks/public_checks/api-health.json`
- `checks/public_checks/api-markets.json`
- `checks/public_checks/api-metadata.json`
- `checks/public_checks/frontend-home.html`
- `checks/public_checks/frontend-methodology.html`
- `checks/public_url_verification.json`
- `checks/public_urls.json`
- `manifest.json`
