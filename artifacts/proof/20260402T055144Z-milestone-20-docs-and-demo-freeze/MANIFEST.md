...
Refresh documentation and demo narrative to match expanded findings/report capabilities.

## Scope

- Updated findings documentation with v2 longitudinal metrics and third finding.
- Updated API spec and integration docs for new endpoints and package shape.
- Updated README, demo script, and submission summary content.
