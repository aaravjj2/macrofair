...
Update findings and methodology UX to surface expanded longitudinal evidence and third finding.

## Scope

- Updated static findings data to 12-snapshot window v2.
- Added third-finding summary and table to findings page.
- Updated methodology evidence section and E2E smoke assertions.
...
- `README.md`
- `TOUR.webm`
- `code/findings-data.ts`
- `code/findings-page.tsx`
- `code/findings-utils.ts`
- `code/methodology-page.tsx`
- `manifest.json`
