...
Expand deterministic longitudinal window from 4 snapshots to 12 and re-baseline persistence evidence.

## Scope

- Added deterministic fixture generator (`scripts/generate_expanded_snapshot_window.py`).
- Regenerated snapshot window fixture to v2 (`data/fixtures/snapshot_window.json`).
- Refreshed persistence artifacts for the expanded window.
...
- `README.md`
- `TOUR.webm`
- `code/generate_expanded_snapshot_window.py`
- `evidence/flagship_persistence.csv`
- `evidence/flagship_persistence.json`
- `evidence/flagship_persistence.svg`
- `evidence/snapshot_window.json`
- `manifest.json`
