...
Ship typed consolidated findings/report/submission payload surfaces and API endpoints.

## Scope

- Added typed schemas for findings index/report/submission payloads.
- Added API endpoints for `/findings`, `/findings/report`, and `/reports/submission`.
- Added service-level payload builders and hash generation.
